...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'ghanataekwandofederation_9b08f5b7b9dd1fb03049_20240310211513_archive.zip';
        const ARCHIVE_SIZE       = '248407766';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '9b08f5b-10211513';
        const SECONDARY_PACKAGE_HASH = 'dffc161-10211513';
